...
public class RndAdaBoostR2 
  ...
  protected void buildClassifierUsingResampling(Instances data) 
	...
	sample = trainData.resampleWithWeights(randomInstance, weights);
        ...
        /*jmaudes begin
         * Me aseguro de q incluso en el caso con remuestreo el clasificador base tome un valor aleatorio
         * para poder usarlo en RotationForest
         */
  ...
  */
  ...
  public static void main(String [] argv) {
    runClassifier(new RndAdaBoostR2(), argv);
  }
}
